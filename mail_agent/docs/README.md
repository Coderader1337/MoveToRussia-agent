...
1. [`STATUS.md`](STATUS.md) — текущий статус: что готово и было проверено, что
   не протестировано, известные ограничения. **Начать отсюда** — там же
   зафиксирована находка про закоммиченные секреты.
...
git) и в личном хранилище паролей владельца. Отдельно см.
[`STATUS.md`](STATUS.md) — там задокументирована находка о секретах, которые
**уже** попали в git и нуждаются в замене.
